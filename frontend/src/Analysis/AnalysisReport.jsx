        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 print:hidden">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <button
              ...
              className="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition text-xs flex items-center space-x-2 shadow-xs cursor-pointer disabled:opacity-50"
            >
              {downloadingPdf ? (
                <>
                ...
                <span>📥 Download Enterprise PDF Report</span>
              )}
            </button>
          </div>
        </div>
